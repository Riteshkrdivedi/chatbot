function getBotResponse(input) {
    ...
    // basic questions
    ...
    } else if (input.toLowerCase().includes("web chair")) {
        ...
        return "If you want t0 join then fill the application form in our website";
        ...
        return "I'm sorry, I don't have an answer for that. Can you please provide more details or rephrase your question?";
    }
}